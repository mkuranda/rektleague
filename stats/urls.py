...
urlpatterns = [
    ...
    url(r'^api/season/(?P<season_id>[0-9]+)/$', views.season_test_detail, name='season_test'),
    ...
    url(r'^api/season/(?P<season_id>[0-9]+)/team/(?P<team_id>[0-9]+)/$', views.team_test_detail, name='team_test_detail'),
